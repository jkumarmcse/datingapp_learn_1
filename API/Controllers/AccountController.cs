...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
        {
            ...
            if (user == null) return Unauthorized("Invalid Username or Invalid Password");
            ...
            {
                if (computedHash[i] != user.Password[i]) return Unauthorized("Invalid Username or Invalid Password");
            }
